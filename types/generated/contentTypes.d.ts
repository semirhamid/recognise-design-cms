...
export interface ApiAboutUsAboutUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    clientHistory: Attribute.Component<'blocks.client-history'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiClientClient extends Schema.SingleType {
  ...
  attributes: {
    clients: Attribute.Component<'elements.test-component', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCompanyVideoCompanyVideo extends Schema.SingleType {
  collectionName: 'company_videos';
  info: {
    singularName: 'company-video';
    pluralName: 'company-videos';
    displayName: 'Company Video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::company-video.company-video',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    quickLinks: Attribute.Component<'elements.menu-item', true>;
    socialLinks: Attribute.Component<'elements.test-component', true>;
    company: Attribute.Component<'elements.menu-item', true>;
    requestCallButton: Attribute.Component<'elements.button-with-link'>;
    footerHeading: Attribute.Text;
    formLabel: Attribute.String;
    privacyLink: Attribute.Component<'elements.menu-item'>;
...
export interface ApiHomeContentHomeContent extends Schema.SingleType {
  ...
  attributes: {
    serviceSection: Attribute.Component<'blocks.text-with-content'>;
    heroTextOne: Attribute.String;
    heroTextTwo: Attribute.String;
    heroTextDynamicThree: Attribute.Component<'elements.text-input', true>;
    aboutUs: Attribute.Component<'blocks.home-about-us-content'>;
    featuredServices: Attribute.Component<
      'blocks.home-featured-services',
      true
    >;
    ...
    OrbitalSection: Attribute.Component<'visual.orbit'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPortfolioPageContentPortfolioPageContent
  extends Schema.SingleType {
  collectionName: 'portfolio_page_contents';
  info: {
    singularName: 'portfolio-page-content';
    pluralName: 'portfolio-page-contents';
    displayName: 'Portfolio page content';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    projectsDone: Attribute.String;
    projectsDoneText: Attribute.String;
    btnText: Attribute.String;
    headingContentText: Attribute.Text;
    headingContentImage: Attribute.Media;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::portfolio-page-content.portfolio-page-content',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiServiceListServiceList extends Schema.CollectionType {
  ...
  attributes: {
    services: Attribute.Component<'elements.title-description-tags'>;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    service_lists: Attribute.Relation<
      'api::tag.tag',
      'manyToMany',
      'api::service-list.service-list'
    >;
...
export interface ApiTestPageTestPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Menus: Attribute.Component<'elements.menu-item', true>;
    ttttt: Attribute.Component<'elements.test-component', true>;
